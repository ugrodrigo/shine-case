...
SQL_FILE = PROJECT_ROOT / "sql" / "shine_eda.sql"
KPI_SQL_FILE = PROJECT_ROOT / "sql" / "kpi_deep_dive.sql"
COHORT_SQL_FILE = PROJECT_ROOT / "sql" / "cohort_state_analysis.sql"
STREAK_SQL_FILE = PROJECT_ROOT / "sql" / "streak_analysis.sql"
CONCENTRATION_SQL_FILE = PROJECT_ROOT / "sql" / "revenue_concentration_analysis.sql"
PRESENTATION_SQL_FILE = PROJECT_ROOT / "sql" / "presentation_kpis.sql"
