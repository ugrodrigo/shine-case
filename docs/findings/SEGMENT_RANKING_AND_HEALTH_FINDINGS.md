...
- `outputs/eda/eda_segment_opportunity_ranking.csv`
- `outputs/eda/eda_comparable_account_health_by_segment.csv`
- `sql/presentation_kpis.sql`
- `outputs/presentation/assets/segment_opportunity_ranking.png`
- `outputs/presentation/assets/segment_health_stacked.png`
