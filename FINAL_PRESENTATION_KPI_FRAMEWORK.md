...
- The highest-value 20% generate **70.24%** of revenue across the first three
  complete calendar months after activation. The raw cumulative sensitivity is
  73.93%.
- BTP represents **26.51%** of this comparable top-20 pool and **30.28%** of its
  revenue.
- Plus and Business are respectively **2.18x** and **3.55x** overrepresented in
  the comparable top 20%.
...
- BTP is the largest scalable high-value persona: 26.51% of the comparable
  top-20 population and 30.28% of its revenue.
- 482 of 1,642 comparable BTP companies are already in the top 20%, leaving
  1,160 outside it as a historical indication of the potential addressable pool.
...
- BTP companies in the top 20%: 482; outside it: 1,160.
- BTP contributes EUR 233.6k, or 30.28%, of top-20 revenue across the first
  three complete post-activation months.
...
> Revenue generated by the top 20% of companies ranked across their first three
> complete calendar months after activation / total revenue across those same
> three months.

Current result: **70.24%**.

Why use it: the revenue source is monthly and cannot split activation-month
revenue at the activation date. Excluding age 0 removes partial-month exposure,
keeps 9,088 comparable companies, and avoids giving older cohorts an unfair
advantage. An exact 90-day window would require daily revenue data. The raw
...
Preferred three-complete-month results:

- BTP: 26.51% of high-value companies, 30.28% of high-value revenue, 1.47x
  represented.
- Plus: 30.80% of high-value companies versus 14.15% of the base, 2.18x.
- Business: only 7.65% of high-value companies but 3.55x represented; valuable
  and risky, but too small to be the only growth recommendation.
- BTP + Plus: 9.35% of the high-value pool, 10.47% of its revenue, 2.44x
  represented.
...
> The highest-value 20% generate 70% of revenue across the first three complete
> post-activation months; BTP contributes
