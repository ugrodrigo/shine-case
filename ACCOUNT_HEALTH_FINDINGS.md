...
- `eda_outputs/eda_company_revenue_momentum_at_cutoff.csv`: company-level audit.
- `eda_outputs/eda_top20_account_health_summary.csv`: revised high-value states.
- `eda_outputs/eda_revenue_momentum_threshold_sensitivity.csv`: threshold tests.
- `eda_outputs/eda_top20_revenue_momentum_by_segment.csv`: persona and plan mix.
